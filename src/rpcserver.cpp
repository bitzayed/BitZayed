...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop BitZayed server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "BitZayed server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BitZayed features */
        {"bitzayed", "masternode", &masternode, true, true, false},
        {"bitzayed", "listmasternodes", &listmasternodes, true, true, false},
        {"bitzayed", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bitzayed", "masternodeconnect", &masternodeconnect, true, true, false},
        {"bitzayed", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bitzayed", "masternodedebug", &masternodedebug, true, true, false},
        {"bitzayed", "startmasternode", &startmasternode, true, true, false},
        {"bitzayed", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bitzayed", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bitzayed", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bitzayed", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bitzayed", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bitzayed", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bitzayed", "mnbudget", &mnbudget, true, true, false},
        {"bitzayed", "preparebudget", &preparebudget, true, true, false},
        {"bitzayed", "submitbudget", &submitbudget, true, true, false},
        {"bitzayed", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"bitzayed", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"bitzayed", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"bitzayed", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"bitzayed", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"bitzayed", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"bitzayed", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bitzayed", "checkbudgets", &checkbudgets, true, true, false},
        {"bitzayed", "mnsync", &mnsync, true, true, false},
        {"bitzayed", "spork", &spork, true, true, false},
        {"bitzayed", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"bitzayed", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
{
    return "> bitzayed-cli " + methodname + " " + args + "\n";
}
