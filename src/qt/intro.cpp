...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("BitZayed Core"),
     ...
     * override -datadir in the bitzayed.conf file in the default data directory
     * (to be consistent with bitzayedd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
