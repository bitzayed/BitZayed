                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("BitZayed Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BitZayed address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bitzayed: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zBZD"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BitZayed Core"), this);
    aboutAction->setStatusTip(tr("Show information about BitZayed Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BitZayed"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BitZayed addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BitZayed addresses"));
    ...
    openAction->setStatusTip(tr("Open a BitZayed: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BitZayed Core help message to get a list with possible BitZayed command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BitZayed Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BitZayed network", "", count));
}
...
{
    QString strTitle = tr("BitZayed Core"); // default title
