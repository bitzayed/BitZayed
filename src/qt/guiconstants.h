...
/* BitZayed GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "BitZayed"
#define QAPP_ORG_DOMAIN "bitzayed.org"
#define QAPP_APP_NAME_DEFAULT "BitZayed-Qt"
#define QAPP_APP_NAME_TESTNET "BitZayed-Qt-testnet"
