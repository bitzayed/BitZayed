 ...
 */
    ...
    typeWidget->addItem(tr("Received BZD from zBZD"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zBZD"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zBZD));
