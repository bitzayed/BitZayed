...
/** Utility functions used by the BitZayed Qt UI.
 */
namespace GUIUtil
{
...
// Render BitZayed addresses in monospace font
...
// Parse "bitzayed:" URI into recipient object, return true on successful parsing
