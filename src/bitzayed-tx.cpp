...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("BitZayed Core bitzayed-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  bitzayed-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitzayed transaction") + "\n" +
                               "  bitzayed-tx [options] -create [commands]   " + _("Create hex-encoded bitzayed transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bitzayed transaction
