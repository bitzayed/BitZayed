...
In order to support loading of multiple wallets in bitzayed-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bitzayed.cpp.
...
Changes to bitzayed.cpp
----------------------
bitzayed.cpp is the entry point into bitzayed-qt, and as such, will require some minor modifications to provide hooks for
