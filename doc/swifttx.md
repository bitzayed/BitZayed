...
This mechanism has been integrated into Bitcore-Node-BitZayed which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/BitZayed-Project/insight-api-bitzayed#web-socket-api](https://github.com/BitZayed-Project/insight-api-bitzayed#web-socket-api) 
* API: [https://github.com/BitZayed-Project/insight-api-bitzayed#swifttx-transactions](https://github.com/BitZayed-Project/insight-api-bitzayed#swifttx-transactions) 
...
By default, the BitZayed Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the BitZayed Core daemon:
