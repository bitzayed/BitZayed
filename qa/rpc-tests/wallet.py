...
#   c) node1 mines 32 blocks, so now node 0 has 60001bzd, node 1 has 4250bzd, node2 has none.
#   d) node0 sends 601 bzd to node2, in two transactions (301 bzd, then 300 bzd).
