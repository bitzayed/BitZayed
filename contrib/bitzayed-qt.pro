...
RESOURCES += src/qt/bitzayed.qrc src/qt/bitzayed_locale.qrc

TRANSLATIONS += src/qt/locale/bitzayed_bg.ts \
                src/qt/locale/bitzayed_de.ts \
                src/qt/locale/bitzayed_en.ts \
                src/qt/locale/bitzayed_es.ts \
                src/qt/locale/bitzayed_fi.ts \
                src/qt/locale/bitzayed_fr.ts \
                src/qt/locale/bitzayed_it.ts \
                src/qt/locale/bitzayed_ja.ts \
                src/qt/locale/bitzayed_pl.ts \
                src/qt/locale/bitzayed_pt.ts \
                src/qt/locale/bitzayed_ru.ts \
                src/qt/locale/bitzayed_sk.ts \
                src/qt/locale/bitzayed_sv.ts \
                src/qt/locale/bitzayed_vi.ts \
                src/qt/locale/bitzayed_zh_CN.ts \
                src/qt/locale/bitzayed_zh_TW.ts
