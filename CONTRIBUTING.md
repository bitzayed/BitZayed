Contributing to BitZayed Core
============================

The BitZayed Core project operates an open contributor model where anyone is
...
The following applies to code changes to the BitZayed Core project, and is not to be
confused with overall BitZayed Network Protocol consensus changes.

Whether a pull request is merged into BitZayed Core rests with the project merge
...
Patches that change BitZayed consensus rules are considerably more involved than
...
Where a patch set proposes to change the BitZayed consensus, it must have been
...
The project leader is the release manager for each BitZayed Core release.
